...
const index = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  ...
  const editing = location2.pathname.includes("localhost");
  if (editing === false) {
...
const routes = [
  [/^\/$/, [Layout, () => Index], void 0, "/", ["q-3daecb7b.js", "q-36304a7d.js"]]
];
const menus = [];
