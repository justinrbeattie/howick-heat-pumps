...
const index = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  ...
  const prod = location2.query["__builder_editing__"] !== "true";
  console.log(prod);
  if (prod) {
...
const routes = [
  [/^\/$/, [Layout, () => Index], void 0, "/", ["q-50171085.js", "q-0bc2691d.js"]]
];
const menus = [];
