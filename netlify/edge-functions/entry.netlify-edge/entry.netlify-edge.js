...
const index = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  ...
  const apiUrl = "https://cdn.builder.io/api/v1/qwik/" + BUILDER_MODEL + "?url=https%3A%2F%2Fcosmic-dusk-68b932.netlify.app%2F&apiKey=" + BUILDER_PUBLIC_API_KEY + "&limit=1&userAttributes.urlPath=" + location.pathname || "/";
  useServerMountQrl(inlinedQrl(async () => {
    const [apiUrl2, store2] = useLexicalScope();
    const response = await fetch(apiUrl2);
    store2.resp = await response.json();
    console.log(store2.resp.html);
  }, "s_dNJ5Ezd0No0", [
    apiUrl,
    store
  ]));
...
const routes = [
  [/^\/$/, [Layout, () => Index], void 0, "/", ["q-576c5e03.js", "q-1d0e2f78.js"]]
];
const menus = [];
