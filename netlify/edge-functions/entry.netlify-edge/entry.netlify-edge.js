...
const index = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  ...
  useServerMountQrl(inlinedQrl(async () => {
    ...
    location3.href.split("?")[1];
    const response = await fetch("https://cdn.builder.io/api/v2/content/page?apiKey=f5a098163c3741e19503f02a69360619&limit=1&userAttributes.urlPath=" + location3.pathname);
...
const routes = [
  [/^\/$/, [Layout, () => Index], void 0, "/", ["q-e21f8f6f.js", "q-001b19f1.js"]]
];
const menus = [];
