...
const index = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  ...
  useServerMountQrl(inlinedQrl(async () => {
    const [location2, store2] = useLexicalScope();
    const response = await fetch("https://cdn.builder.io/api/v1/qwik/page?url=" + location2.pathname + "&apiKey=f5a098163c3741e19503f02a69360619&limit=1");
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: /* @__PURE__ */ jsx("div", {
      dangerouslySetInnerHTML: store.data.html
    })
  });
}, "s_xYL1qOwPyDI"));
...
const routes = [
  [/^\/$/, [Layout, () => Index], void 0, "/", ["q-564fa3ba.js", "q-42a03b8f.js"]]
];
const menus = [];
